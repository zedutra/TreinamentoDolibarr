...
/**
 *  \file       contrato_contact.php
 *  \ingroup    contratos
 *  \brief      Tab for contacts linked to Contrato
 */
...
$hookmanager->initHooks(array('contratocontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($enablepermissioncheck) {
	...
	$permission = $user->rights->contratos->contrato->write;
} else {
	$permissiontoread = 1;
	$permission = 1;
}
...
$title = $langs->trans('Contrato')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Contrato"), -1, $object->picto);
