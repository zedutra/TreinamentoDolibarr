...
/**
 *  \file       parcelamento_note.php
 *  \ingroup    contratos
 *  \brief      Tab for notes on Parcelamento
 */
...
$hookmanager->initHooks(array('parcelamentonote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
llxHeader('', $langs->trans('Parcelamento'), $help_url);
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Parcelamento"), -1, $object->picto);
