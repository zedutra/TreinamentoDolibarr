...
/**
 *  \file       parcelamento_contact.php
 *  \ingroup    contratos
 *  \brief      Tab for contacts linked to Parcelamento
 */
...
$hookmanager->initHooks(array('parcelamentocontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($enablepermissioncheck) {
	...
	$permission = $user->rights->contratos->parcelamento->write;
} else {
	$permissiontoread = 1;
	$permission = 1;
}
...
$title = $langs->trans('Parcelamento')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Parcelamento"), -1, $object->picto);
