...
/**
 *  \file       contrato_note.php
 *  \ingroup    contratos
 *  \brief      Tab for notes on Contrato
 */
...
$hookmanager->initHooks(array('contratonote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
llxHeader('', $langs->trans('Contrato'), $help_url);
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Contrato"), -1, $object->picto);
